...
const Asset = ({ props }) => {
    return (
        <div className={`col-lg gx-2 border border-3 rounded p-2 ms-2 me-2 mb-5 ${props.variation > 0 ? "border-success" : props.variation < 0 ? "border-danger" : "border-secondary"}`}>
            <div className="row">
